...
heritage_graph = open('log.txt', 'r')
fonc_graph= open('logf.txt','r')

out = open('logBigPart.dot', 'wb')
outSmallPart = open('logSmallPart.dot', 'wb')
outSingle= open('logSingle.dot', 'wb')
outTestCase = open('logTestCase.dot', 'wb')
outStatement = open('logStatement.dot', 'wb')
outRunListener= open('logRunListener.dot', 'wb')

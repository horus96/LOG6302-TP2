...
for method in root:
    ...
    for bloc in method:
        ...
        if bloc.tag == "bloc":
            ...
            hasssa = False
            if name.__contains__("wordcount"):
                phis = []
                pis = []
                    ...
                    for phisorpis in bloc:
                        ...
                        if phisorpis.tag == "pis":
                            for pisinstr in phisorpis:
                                cpiinstr = etree.SubElement(cbloc,pisinstr.attrib.get("piinstr"))
                                cpiinstr.set("instruction",pisinstr)
                ...
                for edge in bloc.findall('.edge'):
                    if not(isNull):
                        ...
                        if nametarget.__contains__("wordcount"):
